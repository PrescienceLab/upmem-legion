...
namespace Realm {
 ...
 ////////////////////////////////////////////////////////////////////////
        ...
        , redop_info(_redop_info)
      {
        ...
        // (redop_info.is_fold ?
        //     (redop_info.is_exclusive ? redop->upmem_fold_excl_fn : redop->upmem_fold_nonexcl_fn) :
        //     (redop_info.is_exclusive ? redop->upmem_apply_excl_fn : redop->upmem_apply_nonexcl_fn));
      ...
      bool DPUreduceXferDes::progress_xd(DPUreduceChannel *channel,
      ...
      DPUreduceChannel::DPUreduceChannel(DPU *_dpu, BackgroundWorkManager *bgwork)
        : SingleXDQChannel<DPUreduceChannel,DPUreduceXferDes>(bgwork,
                                                              XFER_DPU_IN_MRAM,
                                                              " ") // _dpu->info->index
        , dpu(_dpu)
      {
      ...
      uint64_t DPUreduceChannel::supports_path(ChannelCopyInfo channel_copy_info,
      ...
      {
        return new DPUreduceRemoteChannelInfo(node, kind,
                                              reinterpret_cast<uintptr_t>(this),
                                              paths);
      }

      XferDes *DPUreduceChannel::create_xfer_des(uintptr_t dma_op,
                                                 NodeID launch_node,
                                                 XferDesID guid,
                                                 const std::vector<XferDesPortInfo>& inputs_info,
                                                 const std::vector<XferDesPortInfo>& outputs_info,
      ...
      {
        assert(fill_size == 0);
        return new DPUreduceXferDes(dma_op, this, launch_node, guid,
                                    inputs_info, outputs_info,
                                    priority,
                                    redop_info);
      }
      ...
      DPUreduceRemoteChannelInfo::DPUreduceRemoteChannelInfo(NodeID _owner,
                                                             XferDesKind _kind,
      ...
      template <typename S>
      /*static*/ RemoteChannelInfo *DPUreduceRemoteChannelInfo::deserialize_new(S& deserializer)
      {
        NodeID owner;
        XferDesKind kind;
      ...
      /*static*/ Serialization::PolymorphicSerdezSubclass<RemoteChannelInfo,
                                                          DPUreduceRemoteChannelInfo> DPUreduceRemoteChannelInfo::serdez_subclass;
      ...
      uint64_t DPUreduceRemoteChannel::supports_path(ChannelCopyInfo channel_copy_info,
                                                     CustomSerdezID src_serdez_id,
                                                     CustomSerdezID dst_serdez_id,
                                                     ReductionOpID redop_id,
                                                     size_t total_bytes,
