...
namespace Upmem {
    ...
    public:
        DPUTransferCompletion(XferDes* _xd, int _read_port_idx,
    ...
    public:
        DPUXferDes(uintptr_t _dma_op, Channel* _channel,
    ...
    public:
        DPUChannel(DPU* _src_dpu, XferDesKind _kind,
    ...
    public:
        DPUfillXferDes(uintptr_t _dma_op, Channel* _channel,
            NodeID _launch_node, XferDesID _guid,
            const std::vector<XferDesPortInfo>& inputs_info,
            const std::vector<XferDesPortInfo>& outputs_info,
            int _priority,
